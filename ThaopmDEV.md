# Self-Hosted LLM Server with llama.cpp (Ubuntu VM)

Hướng dẫn build và chạy Local LLM Server sử dụng `llama.cpp` trên Ubuntu (VirtualBox), tương thích OpenAI API.
